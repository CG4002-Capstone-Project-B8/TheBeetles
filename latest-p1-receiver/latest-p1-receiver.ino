...
// has P2's address to detect if they were shot by P2
uint8_t PLAYER_TWO_RECEIVE_COMMAND = 0xCC;
uint16_t PLAYER_TWO_ADDRESS = 0x2B12;
...
void checkIfReceivedShot() {
  if (IrReceiver.decode()) {
    if (IrReceiver.decodedIRData.command == PLAYER_TWO_RECEIVE_COMMAND) {      
